...
| `smart-home-owner-pack-v0/` | `scene_pack://smart-home-owner-project-ops` | 长周期项目交付型 | 完整文件夹包；流式阻断终态已 GUI 验收，按 v15 单项目完整 lifecycle 计划补全 flow/Provider/作者台/按钮覆盖（未发布） | 智能家居老板项目经营：机会、Frappe 项目 / 客户快照、项目经理建议、里程碑 / 采购 / 施工候选、客户沟通、Frappe 写回候选、项目回执。 |
