...
# -*- coding: utf-8 -*-
"""
备份管理员工作台 Pack（客户服务全生命周期）—— 从正在运行的 Truzhen devserver 卸载。
...
用法：
  TRUZHEN_DEVSERVER_BASE=http://127.0.0.1:18080 python3 backup-administrator-workbench-v0/uninstall.py
...
def main():
    ...
    pack_name = manifest.get("name", "备份管理员工作台 Pack")
    ...
    code, body = call("POST", "/v3/base/gated-actions/prepare", {
        ...
        "target_ref": pack_ref,
        "content_summary": "停用备份管理员工作台 Pack：" + pack_ref,
